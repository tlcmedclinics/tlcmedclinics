...
const FACTS = [
  { Icon: BrainIcon, key: "home.ket.fact1" },
  { Icon: StethoscopeIcon, key: "home.ket.fact2" },
  { Icon: DropletIcon, key: "home.ket.fact3" },
  { Icon: ShieldIcon, key: "home.ket.fact4" },
];
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-start lg:gap-16">
          <Reveal>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-4">
              ...
              >
                <T k="home.ket.cta.more" />
              </Link>
            </div>
          </Reveal>

          <div className="grid gap-4 sm:grid-cols-2">
            {FACTS.map(({ Icon, key }, i) => (
              <Reveal key={key} delay={100 + i * 90}>
